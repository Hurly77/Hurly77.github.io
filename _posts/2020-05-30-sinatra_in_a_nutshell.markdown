...
Now in our models class, we want to make our association that way we can use association methods that we inherit from ActiveRecord.
...
This will give us access to all the user's via instance variable
